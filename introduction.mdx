...
├── run/00-my-first-requirements/                  
    ├── 00-requirements.md          # Stable functional-area knowledge
    ├── 01-as-is.md                 # Reusable playbooks and solution patterns
    ├── 02-to-be.md                 # Recurring failure signatures and fixes
    ├── 03-implementation-summary.md  # Distilled lessons from specific runs
    ├── 04-manual-qa.md           # Historical or deprecated memory docs
